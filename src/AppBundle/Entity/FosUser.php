...
class FosUser
{
     ...
     * @var string
     *
     * @ORM\Column(name="ufirst_name", type="string", length=25, nullable=false)
     */
    private $ufirstName;
     ...
     * @var string
     *
     * @ORM\Column(name="ulast_name", type="string", length=25, nullable=false)
     */
    private $ulastName;
     ...
     * @var simplearray
     *
     * @ORM\Column(name="access_level", type="simplearray", nullable=false)
     */
    private $accessLevel;
     ...
     * @var simplearray
     *
     * @ORM\Column(name="allowed_actions", type="simplearray", nullable=false)
     */
     ...
     * Set accessLevel
     *
     * @param \simplearray $accessLevel
     * @return FosUser
     */
    public function setAccessLevel(\simplearray $accessLevel)
    {
     ...
     * Set allowedActions
     *
     * @param \simplearray $allowedActions
     * @return FosUser
     */
    public function setAllowedActions(\simplearray $allowedActions)
    {
